...
- [x] **UI-04**: Home screen uses card-stack layout with today's workout, weekly streak, and quick stats (per Sketch 001-A)
- [x] **UI-05**: Session screen uses compact video layout with Previous/Best context cards (per Sketch 002-B)
- [x] **UI-06**: Coach chat displays "Hone" branded identity with warm gradient avatar and personality-driven copy (per Sketch 003-C)
- [x] **UI-07**: Session summary screen uses tighter layout so emoji difficulty picker is visible without scrolling
